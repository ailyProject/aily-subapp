...
async function startVideoConverterServer(options = {}) {
  ...
  const core = createVideoConverterCore({
  ...
  async function stop() {
    ...
    for (const client of clients) {
      client.close(1001, 'Video converter server closed');
    }
