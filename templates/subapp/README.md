...
`{{Tool Name}}` is a template child application for Aily Blockly / Aily Chat AI IDE. Copy this directory, replace the placeholders, and then put the real tool behavior in `core.js`, `cli.js`, `server.js`, and `ui/app.js`.
